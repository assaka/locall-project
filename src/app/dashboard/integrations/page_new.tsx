...
export default function IntegrationsPage() {
  ...
  const [providers, setProviders] = useState<IntegrationProvider[]>(mockProviders);
  const [metrics, setMetrics] = useState<SyncMetrics>(mockSyncMetrics);
  const [activity, setActivity] = useState<RealtimeActivity[]>(mockActivity);
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <MetricCard
            ...
            value={`${metrics.dataTransferred}MB`}
            subtitle="This month"
            icon={<StorageIcon />}
            color="#9c27b0"
